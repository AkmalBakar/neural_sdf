...
class SDFDataset(Dataset):
    def __init__(self, sampler: MeshSampler, num_samples: int):
        self.sampler = sampler
        self.num_samples = num_samples
        self.resample()

    def resample(self):
        self.x_sample = self.sampler.sample_points(self.num_samples)
        self.sdf_sample = self.sampler.sdf(self.x_sample)

    def __len__(self):
        return self.num_samples

    def __getitem__(self, idx):
        return self.x_sample[idx], self.sdf_sample[idx]
