...
x_sample_surface = jax.random.ball(key, 2, 2, (1000,))
# Project to circle surface
x_sample_surface = x_sample_surface / jnp.linalg.norm(x_sample_surface, axis=-1)[:,jnp.newaxis]
plt.scatter(x_sample_surface[:,0], x_sample_surface[:,1])
plt.show()
